...
final class NetworkingProvider {
    ...
    func getStop(numberStop: String, success: @escaping (_ stopResponse: StopsResponse) -> (), failure: @escaping (_ error: Error?) -> ()) {
        let url = "\(kBaseUrlInterUrban)0/query?where=CODIGOESTACION=\(numberStop)&outFields=CODIGOESTACION,DENOMINACION,CORONATARIFARIA,LINEAS&f=json"
    ...
    func getAllStops(success: @escaping (_ allStopsResponse: StopsResponse) -> (), failure: @escaping (_ error: Error?) -> ()) {
        let url = "\(kBaseUrlInterUrban)0/query?where=1%3D1&outFields=CODIGOESTACION,DENOMINACION,CORONATARIFARIA,LINEAS&outSR=4326&f=json"
    ...
    func getStopByLine(numberLine: String, success: @escaping (_ stopsByLineResponse: StopsLinesResponse) -> (), failure: @escaping (_ error: Error?) -> ()) {
        ...
        let url = "\(kBaseUrlInterUrban)3/query?where=NUMEROLINEAUSUARIO='\(numberLine)'&outFields=NUMEROLINEAUSUARIO,SENTIDO,NUMEROORDEN,DENOMINACION,DIRECCION,CORONATARIFARIA,CODIGOESTACION&outSR=4326&f=json"
    ...
    func getAllStopsByLine(success: @escaping (_ allStopsByLineResponse: StopsLinesResponse) -> (), failure: @escaping (_ error: Error?) -> ()) {
        let url = "\(kBaseUrlInterUrban)3/query?where=1%3D1&outFields=NUMEROLINEAUSUARIO,SENTIDO,NUMEROORDEN,DENOMINACION,DIRECCION,CORONATARIFARIA,CODIGOESTACION&outSR=4326&f=json"
    ...
    func getStopByLocation(nameLocation: String, success: @escaping (_ stopsByLocationResponse: StopsLinesResponse) -> (), failure: @escaping (_ error: Error?) -> ()) {
        ...
        let url = "\(kBaseUrlInterUrban)3/query?where=MUNICIPIO='\(nameLocation)'&outFields=NUMEROLINEAUSUARIO,SENTIDO,NUMEROORDEN,DENOMINACION,DIRECCION,CORONATARIFARIA,CODIGOESTACION,MUNICIPIO&outSR=4326&f=json"
